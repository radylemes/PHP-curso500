                ...
                <tbody>
                    <?php  while($produto = mysqli_fetch_assoc($produtos)): ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger mr-4 " href="?pagina=deletar_produto&id=<?= $produto['id']; ?>"><i class="fas fa-trash-alt"></i></a>
                                <a class="btn btn-primary" href="?pagina=editar_produto&id=<?= $produto['id']; ?>"><i class="far fa-edit"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
